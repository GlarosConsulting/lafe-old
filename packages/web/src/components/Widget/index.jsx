...
class Widget extends React.Component {
  ...
  handleClose = () => {
    const { hideWidget } = this.state;

    this.setState({ hideWidget: !hideWidget });
  };

  handleCollapse = () => {
    const { collapseWidget } = this.state;
  ...
  handleFullscreen = () => {
    const { fullscreened } = this.state;

    this.setState({ fullscreened: !fullscreened });
  };
