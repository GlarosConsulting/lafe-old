/* eslint-disable jsx-a11y/anchor-is-valid, global-require */
...
class Static extends React.Component {
  ...
  checkAll(ev, checkbox) {
    this.setState(state => {
      const checkboxArr = new Array(state[checkbox].length).fill(
        ev.target.checked,
      );
  ...
  changeCheck(ev, checkbox, id) {
    this.setState(state => {
      state[checkbox][id] = ev.target.checked;

      if (!ev.target.checked) {
        state[checkbox][0] = false;
      }
  ...
  render() {
    const { tableStyles, checkboxes1, checkboxes2, checkboxes3 } = this.state;

    return (
      <div className={s.root}>
        <h2 className="page-title">
          <span>Tables -</span>
          <span className="fw-semi-bold">Static</span>
        </h2>
        <Row>
          <Col>
            <Widget
        ...
        <Row>
          <Col lg={6}>
            ...
            >
              ...
              <h3>
                <span>Hover</span>
                <span className="fw-semi-bold">Table</span>
              </h3>
              <p>
                {"Trace only what's really important. "}
                <code>.table-hover</code>
                <span>is made for it.</span>
              </p>
          ...
          <Col lg={6}>
                ...
                <tbody>
                  <tr>
                    ...
                    <td className="text-center">
                      ...
                      >
                        <SparklinesBars
                          style={{ stroke: 'white', fill: '#1870DC' }}
                        />
                      </Sparklines>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td className="text-center">
                      ...
                      >
                        <SparklinesBars
                          style={{ stroke: 'white', fill: '#58D777' }}
                        />
                      </Sparklines>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td className="text-center">
                      ...
                      >
                        <SparklinesBars
                          style={{ stroke: 'white', fill: '#f0af03' }}
                        />
                      </Sparklines>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td className="text-center">
                      ...
                      >
                        <SparklinesBars
                          style={{ stroke: 'white', fill: '#F45722' }}
                        />
                      </Sparklines>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td className="text-center">
                      ...
                      >
                        <SparklinesBars
                          style={{ stroke: 'white', fill: '#4ebfbb' }}
                        />
                      </Sparklines>
                    </td>
                  </tr>
            ...
            >
              ...
              <p>
                ...
                <code>.widget-table-overflow</code>
                <span>inside of widget</span>
              </p>
